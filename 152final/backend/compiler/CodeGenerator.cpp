 ...
 */
void CodeGenerator::emitComment(GooeyParser::StatementContext *ctx)
{
...
string CodeGenerator::typeDescriptor(Typespec *GooeyType)
{
    Form form = GooeyType->getForm();
    string descriptor;

    while (form == ARRAY)
    {
        descriptor += "[";
        GooeyType =  GooeyType->getArrayElementType();
        form = GooeyType->getForm();
    }

    GooeyType = GooeyType->baseType();
    string str;

    if      (GooeyType == Predefined::integerType) str = "I";
    else if (GooeyType == Predefined::realType)    str = "F";
    else if (GooeyType == Predefined::booleanType) str = "Z";
    else if (GooeyType == Predefined::charType)    str = "C";
...
string CodeGenerator::objectTypeName(Typespec *GooeyType)
{
    Form form = GooeyType->getForm();
    string typeName;
    bool isArray = false;
    ...
    if      (GooeyType == Predefined::integerType) str = "java/lang/Integer";
    else if (GooeyType == Predefined::realType)    str = "java/lang/Float";
