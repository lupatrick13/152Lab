...
public:
     ...
     */
    void emitComment(GooeyParser::StatementContext *ctx);
    ...
    /**
     * Return a type descriptor for a Gooey datatype.
     * @param GooeyType the datatype.
     * @return the type descriptor.
     */
    string typeDescriptor(Typespec *GooeyType);

    /**
     * Return the Java object name for a Gooey datatype.
     * @param GooeyType the datatype.
     * @return the object name.
     */
    string objectTypeName(Typespec *GooeyType);
