...
string CrossReferencer::toString(Object value, Typespec *type) const
{
    ...
    else if (type == Predefined::labelType)	  return value.as<string>();
    else if (type == Predefined::buttonType)  return value.as<string>();
    else if (type == Predefined::panelType)	  return value.as<string>();
